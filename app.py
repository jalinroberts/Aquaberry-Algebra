...
df = pd.read_csv('/Applications/Bellarmine DS Spring 2024/DS Senior Capstone/winequality-white.csv',sep=';')
df2 = pd.read_csv('/Applications/Bellarmine DS Spring 2024/DS Senior Capstone/winequality-red.csv',sep=';')
